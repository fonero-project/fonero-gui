...
<html>
    ...
    <div id="container" class="container-fluid">
        <form>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <button id="gen_wallet_btn" type="button" class="btn btn-outline-primary" onclick="create_new_wallet()"><i class="fa fa-file"></i> Create</button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label for="seed">Mnemonic Seed:</label>    <button id="paste_seed_btn" type="button" class="btn btn-outline-warning btn-sm" style="text-transform: none" onclick="paste_seed()"><i class="fa fa-paste"></i> Paste</button>
                            <textarea id="seed" class="form-control" placeholder="Paste 25 mnemonic seed words here (use [Paste] button above or press Ctrl+V)" style="height:80px;margin-bottom:10px;margin-top:10px;"></textarea>
                            <button id="restore_wallet_btn" type="button" class="btn btn-outline-primary" onclick="restore_wallet()"><i class="fa fa-undo"></i> Restore</button>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <button id="import_wallet_btn" type="button" class="btn btn-outline-primary" onclick="import_wallet()"><i class="fa fa-cloud-upload"></i> Import</button>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12" style="background: transparent; text-align: center;">
                        <button id="btn_cancel" type="button" class="btn btn-outline-danger center" onclick="close_dialog()"><i class="fa fa-close"></i> Close</button>
                    </div>
                </div>
            </div>
            <div id="wallet_info" style="display: none">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input id="wallet_address" type="text" class="form-control address-box" style="color:#c7254e;" readonly="readonly" value="Fonero..."/>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea id="wallet_seed_words" class="form-control address-box" style="height:70px;color:#333" readonly="readonly"></textarea>
                        </div>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-12" style="background: transparent; text-align: center;">
                        <button id="btn_open_wallet" type="button" class="btn btn-outline-success" onclick="close_dialog()">Open Wallet &rsaquo;&rsaquo;</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="progress">
        <div class="centered">
            ...
            <p style="margin-top: 140px"><button id="btn_cancel_progress" type="button" class="btn btn-outline-warning center" onclick="cancel_progress()"><i class="fa fa-close"></i> Cancel</button></p> 
        </div>
    </div>
    </body>
</html>
