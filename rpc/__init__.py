...
from settings import REMOTE_DAEMON_HOST, REMOTE_DAEMON_PORT, WALLET_RPC_HOST, WALLET_RPC_PORT
...
class DaemonRPCRequest():
    def __init__(self, app):
        self.url = "http://%s:%s/json_rpc" % (REMOTE_DAEMON_HOST, REMOTE_DAEMON_PORT)
        self.app = app
...
class WalletRPCRequest():
	...
	self.url = "http://%s:%s/json_rpc" % (WALLET_RPC_HOST, WALLET_RPC_PORT)
        self.app = app
